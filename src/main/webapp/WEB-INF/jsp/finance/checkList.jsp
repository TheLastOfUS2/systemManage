...
<head>
    ...
    <!-- 本页js -->
    <script type="text/javascript" src="resources/js/finance/checkList.js"></script>
    <!-- 分页 -->
...
<div id="dlg-toolbar" style="padding:5px;height:auto;display: none">
    <table cellpadding="0" cellspacing="0">
        <tr>
            <%--<td>--%>
            <%--<a id="downloadAllFiles" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">下载全部</a>--%>
            <%--</td>--%>
            <td>
                <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true"
                   onclick="downloadCheckList()">下载</a>
            </td>
            <td>
            ...
            <td>
                <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-xls',plain:true"
                   onclick="excel()">导出</a>
            </td>
            <td><!-- prompt:'请输入检索关键字', -->
                <input id="searchboxId" class="easyui-searchbox" data-options="menu:'#mm',searcher:doSearch"
                       style="width:200px"></input>
                <div id="mm">
                    <div data-options="name:'projectName'">项目名</div>
                    <div data-options="name:'baseInfoName'">申报人</div>
                    <div data-options="name:'rbAmount'">申报金额</div>
                    <div data-options="name:'recordStatus'">申报状态</div>
                    <div data-options="name:'recordType'">资金类型</div>
                </div>
            </td>
        </tr>
    </table>
...
<div id="dlg" class="easyui-dialog"  data-options="closed:true,buttons:'#dlg-buttons'" style='display: none'>
    <div style="margin: 50px;">
        <div ><h2 style="border-bottom:1px solid #999">修改金额</h2></div>
        <input type="text" id="rbAmountEdit" name="rbAmountEdit">
...
<%--<!-- 导出提示框 -->--%>
<div id="dlgExcel" class="easyui-dialog" title="系统提示" data-options="iconCls:'icon-save',closed:true"
     style="width:260px;height:130px;padding:20px;text-align: center">
    文件生成成功,
    <a href='javascript:void(0)' class='easyui-linkbutton' data-options='plain:true' style="width:70px;height:30px;"
       onclick="exportExcel()">点此下载</a>
</div>
<!-- 导出提示框 -->
