		...
		<table cellpadding="0" cellspacing="0">  
			<tr>  
            	...
            	<td><!-- prompt:'请输入检索关键字', -->
            		...
            		<div id="mm">
            			<!-- 报纸 -->
						<div id="mnId1" data-options="name:'publicityTheme'">名称</div>
						<div id="tnId2" data-options="name:'publicityTheme'">任务名称</div>
						<div id="mnId3" data-options="name:'publicityTheme'">会议名称</div>
						<div id="tId1" data-options="name:'publicityTitle'">任务</div>
						<%--<div id="iId1" data-options="name:'publicityInterviewee'">受访人</div>--%>
						<div id="cId1" data-options="name:'publicityCompany'">字数</div>
						<div id="pId1" data-options="name:'publicityPosition'">层次</div>
						<div id="tiId1" data-options="name:'publicityTime'">撰写时间</div>
						<!-- 期刊 -->
						<div id="tId2" data-options="name:'publicityTitle'">任务描述</div>
						<%--<div id="iId3" data-options="name:'publicityInterviewee'">被宣传人</div>--%>
						<div id="vId" data-options="name:'publicityVolume'">主要贡献</div>
	         		...
	         		<div id="Staff" class="Staff" style="width:100%">
	         			...
	         			<table id="Staff1" class="StaffInfo" style="display:none">
	         				<tbody>
								...
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>任务:</label></td>
									<td width='180' colspan='3'>
										<select id='publicityTitle' name='publicityTitle' style='width:448px'>
											<option value="牵头人">牵头人</option>
											<option value="参与人">参与人</option>
										</select>
									<%--<input type='text' id='publicityTitle' name='publicityTitle' class='easyui-textbox' style='width:448px'>--%>
									</td>
								</tr>
								<%--<tr>--%>
								...
								<%--</tr>--%>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>字数:</label></td>
									<td width='180' colspan='3'>
								...
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>层次:</label></td>
									<td width='180' colspan='3'>
										<select id='publicityPosition' name='publicityPosition' style='width:448px'>
											<option value="院级">院级</option>
											<option value="校级">校级</option>
											<option value="研究基地">研究基地</option>
										</select>
	         			...
	         			<table id="Staff2" class="StaffInfo" style="display:none">
	         				<tbody>
	         					<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>任务名称:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='publicityTheme' name='publicityTheme' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>任务描述:</label></td>
									<td width='180' colspan='3'>
								...
								<%--</tr>--%>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>任务时间:</label></td>
									<td width='180'>
									<input type='text' id='publicityTime' name='publicityTime' class='easyui-datebox'></td>
								</tr>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>主要贡献:</label></td>
									<td width='180'  colspan='3'>
									<input type='text' data-options='multiline:true' id='publicityVolume' name='publicityVolume' class='easyui-textbox'
										   style='width:448px;height: 50px'></td>
								</tr>
								<%--<tr>--%>
	         			...
	         			<table id="Staff3" class="StaffInfo" style="display:none">
	         				<tbody>
								...
								<%--</tr>--%>
								<tr>
									<td width='120' style='text-align:right;'><label class='in_label'>承担主要任务:</label></td>
									<td width='180' colspan='3'>
									<input type='text' id='publicityTitle' name='publicityTitle' class='easyui-textbox' style='width:448px'></td>
								</tr>
								<%--<tr>--%>
