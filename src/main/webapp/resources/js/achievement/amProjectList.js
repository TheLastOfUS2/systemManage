	...
	function addCollaborator(){
		...
		"</td>"+
		"<td>" +
		"<input readonly='readonly' style='border:1px solid #bdc7d8;height:22px' type='text' name='amCollaborators[" + collaboratorNum + "].collaboratorContent' >"+
		"</td>"+
		"<td>"+
	...
	function editCollaborator(data){
		for(var i=0;i<data.amCollaborators.length;i++){
			...
			var targetObj =$("#collaboratorId").append("<tbody id='tbody"+i+"'>" +
					...
					"</td>"+
					"<td>" +
					"<input readonly='readonly' style='border:1px solid #bdc7d8;height:22px' type='text' name='amCollaborators[" + i + "].collaboratorContent' value='"+data.amCollaborators[i].collaboratorContent+"'>"+
					"</td>"+
					"<td>"+
