...
var third_menus = {
    ...
    "g11": {
        ...
        "menuname" : "财务申报",
        "icon" : "icon-nav",
        "url" : "faDeclare/toDeclareList?menuid=g11"
    },
    "g12": {
        "menuid" : "g12",
        "menuname" : "财务审批",
        "icon" : "icon-nav",
        "url" : "faCheck/toCheckList?menuid=g12"
    },
    "g13": {
        "menuid" : "g13",
        "menuname" : "资金分配",
        "icon" : "icon-nav",
        "url" : "faCa/toCaList?&menuid=g13"
    }
};
...
function getPower(power) {
	...
	if(powers != undefined) {
        ...
        if(power.indexOf(",g,") >= 0) {
            menu_result.point6 = [];
            var point6 = menu_result.point6;
            setMenuData(point6, powerArray, "g");
        }
	}
	return menu_result;
}
